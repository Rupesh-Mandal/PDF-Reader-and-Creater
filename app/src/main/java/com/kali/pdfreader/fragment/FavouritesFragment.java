package com.kali.pdfreader.fragment;
...
import com.kali.pdfreader.activity.FavouritesActivity;
import com.kali.pdfreader.activity.MainActivity;
import com.kali.pdfreader.customviews.MyCardView;
import com.kali.pdfreader.fragment.texttopdf.TextToPdfFragment;
import com.kali.pdfreader.model.HomePageItem;
import com.kali.pdfreader.util.CommonCodeUtils;

import static com.kali.pdfreader.util.Constants.ADD_IMAGES;
import static com.kali.pdfreader.util.Constants.ADD_IMAGES_KEY;
import static com.kali.pdfreader.util.Constants.ADD_PASSWORD_KEY;
import static com.kali.pdfreader.util.Constants.ADD_PWD;
import static com.kali.pdfreader.util.Constants.ADD_TEXT_KEY;
import static com.kali.pdfreader.util.Constants.ADD_WATERMARK;
import static com.kali.pdfreader.util.Constants.ADD_WATERMARK_KEY;
import static com.kali.pdfreader.util.Constants.BUNDLE_DATA;
import static com.kali.pdfreader.util.Constants.COMPRESS_PDF;
import static com.kali.pdfreader.util.Constants.COMPRESS_PDF_KEY;
import static com.kali.pdfreader.util.Constants.EXCEL_TO_PDF_KEY;
import static com.kali.pdfreader.util.Constants.EXTRACT_IMAGES;
import static com.kali.pdfreader.util.Constants.EXTRACT_IMAGES_KEY;
import static com.kali.pdfreader.util.Constants.EXTRACT_TEXT_KEY;
import static com.kali.pdfreader.util.Constants.HISTORY_KEY;
import static com.kali.pdfreader.util.Constants.IMAGE_TO_PDF_KEY;
import static com.kali.pdfreader.util.Constants.INVERT_PDF_KEY;
import static com.kali.pdfreader.util.Constants.MERGE_PDF_KEY;
import static com.kali.pdfreader.util.Constants.PDF_TO_IMAGES;
import static com.kali.pdfreader.util.Constants.PDF_TO_IMAGES_KEY;
import static com.kali.pdfreader.util.Constants.QR_BARCODE_KEY;
import static com.kali.pdfreader.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static com.kali.pdfreader.util.Constants.REMOVE_PAGES;
import static com.kali.pdfreader.util.Constants.REMOVE_PAGES_KEY;
import static com.kali.pdfreader.util.Constants.REMOVE_PASSWORD_KEY;
import static com.kali.pdfreader.util.Constants.REMOVE_PWd;
import static com.kali.pdfreader.util.Constants.REORDER_PAGES;
import static com.kali.pdfreader.util.Constants.REORDER_PAGES_KEY;
import static com.kali.pdfreader.util.Constants.ROTATE_PAGES;
import static com.kali.pdfreader.util.Constants.ROTATE_PAGES_KEY;
import static com.kali.pdfreader.util.Constants.SPLIT_PDF_KEY;
import static com.kali.pdfreader.util.Constants.TEXT_TO_PDF_KEY;
import static com.kali.pdfreader.util.Constants.VIEW_FILES_KEY;
import static com.kali.pdfreader.util.Constants.ZIP_TO_PDF_KEY;
