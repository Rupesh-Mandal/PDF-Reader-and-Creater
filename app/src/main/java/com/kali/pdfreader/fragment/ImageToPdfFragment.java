...
import com.kali.pdfreader.activity.CropImageActivity;
import com.kali.pdfreader.activity.ImageEditor;
import com.kali.pdfreader.activity.PreviewActivity;
import com.kali.pdfreader.activity.RearrangeImages;
import com.kali.pdfreader.adapter.EnhancementOptionsAdapter;
import com.kali.pdfreader.database.DatabaseHelper;
import com.kali.pdfreader.interfaces.OnItemClickListener;
import com.kali.pdfreader.interfaces.OnPDFCreatedInterface;
import com.kali.pdfreader.model.EnhancementOptionsEntity;
import com.kali.pdfreader.model.ImageToPDFOptions;
import com.kali.pdfreader.model.Watermark;
import com.kali.pdfreader.util.Constants;
import com.kali.pdfreader.util.CreatePdf;
import com.kali.pdfreader.util.DialogUtils;
import com.kali.pdfreader.util.FileUtils;
import com.kali.pdfreader.util.ImageEnhancementOptionsUtils;
import com.kali.pdfreader.util.ImageUtils;
import com.kali.pdfreader.util.MorphButtonUtility;
import com.kali.pdfreader.util.PageSizeUtils;
import com.kali.pdfreader.util.PermissionsUtils;
import com.kali.pdfreader.util.StringUtils;

import static com.kali.pdfreader.util.Constants.AUTHORITY_APP;
import static com.kali.pdfreader.util.Constants.DEFAULT_BORDER_WIDTH;
import static com.kali.pdfreader.util.Constants.DEFAULT_COMPRESSION;
import static com.kali.pdfreader.util.Constants.DEFAULT_IMAGE_BORDER_TEXT;
import static com.kali.pdfreader.util.Constants.DEFAULT_IMAGE_SCALE_TYPE_TEXT;
import static com.kali.pdfreader.util.Constants.DEFAULT_PAGE_COLOR;
import static com.kali.pdfreader.util.Constants.DEFAULT_PAGE_SIZE;
import static com.kali.pdfreader.util.Constants.DEFAULT_PAGE_SIZE_TEXT;
import static com.kali.pdfreader.util.Constants.DEFAULT_QUALITY_VALUE;
import static com.kali.pdfreader.util.Constants.IMAGE_SCALE_TYPE_ASPECT_RATIO;
import static com.kali.pdfreader.util.Constants.MASTER_PWD_STRING;
import static com.kali.pdfreader.util.Constants.OPEN_SELECT_IMAGES;
import static com.kali.pdfreader.util.Constants.READ_WRITE_CAMERA_PERMISSIONS;
import static com.kali.pdfreader.util.Constants.RESULT;
import static com.kali.pdfreader.util.Constants.STORAGE_LOCATION;
import static com.kali.pdfreader.util.Constants.appName;
import static com.kali.pdfreader.util.WatermarkUtils.getStyleNameFromFont;
import static com.kali.pdfreader.util.WatermarkUtils.getStyleValueFromName;
